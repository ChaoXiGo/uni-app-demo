...
const onClickLogin = async () => {
  const res = await loginSimpleAPI('13212312352')
  loginSuccess(res.result)
}
...
<template>
  <view class="viewport">
    <view class="logo">
      <image src="D:\miniprogram\app-demo\src\static\images\locate.png"></image>
    </view>
    <view class="login">
      <!-- 网页端表单登录 -->
